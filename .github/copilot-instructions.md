...
- Писать подробный коммит по изменениям в стиле Conventional Commits.
- Использовать страдательный залог (краткие причастия: добавлен, исправлен, обновлён, удалён, изменён). Избегать конструкций с "был/была".
- Писать на русском языке.
- Первая строка (заголовок) — краткая суть с префиксом (feat:, fix: и т.д.).
