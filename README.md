...
Wepps — это гибкая платформа для создания сайтов и REST API на PHP. Использует Smarty для шаблонизации, MySQL для хранения данных и предоставляет удобный интерфейс администрирования.
