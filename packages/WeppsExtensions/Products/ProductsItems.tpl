...
<div class="products-wrapper">
	<div class="items products pps_flex pps_flex_row pps_flex_row_str pps_flex_start pps_flex_margin">
		{foreach name="out" item="item" from=$products} {assign var=images
		value=$item.Images_FileUrl|strarr}
		<div class="item pps_flex_13 pps_flex_12_view_medium pps_flex_11_view_small pps_border">
			{if $item.PStatus}
