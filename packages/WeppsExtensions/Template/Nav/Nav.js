var navInit = function() {
	...
	$('a#header-nav,a#footer-nav').on('click', function(e) {
		...
		if ($('.w_nav').length!=0) {
			...
			header.append("<div class=\"logo w_theme_block_light\"><a href=\"/\"><img src=\"/ext/Template/files/wepps.svg\" class=\"w_image\" /></div>");
			header.append("<div class=\"logo w_theme_block_dark\"><a href=\"/\"><img src=\"/ext/Template/files/wepps-white.svg\" class=\"w_image\" /></a></div>");
			popup.append(header);
