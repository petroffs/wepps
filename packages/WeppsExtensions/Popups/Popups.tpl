<label class="pps pps_button">
	<input type="button" value="plain popup" onclick="layoutWepps.win({ size:'small',content: $('#test')});"/>
</label>
<label class="pps pps_button">
	<input type="button" value="ajax popup" onclick="layoutWepps.win({ size:'medium',data:'action=test',url:'/ext/PopupsPage/Request.php' });"/>
</label>
<label class="pps pps_button">
