<div class="page legal-item">
	<section class="legal-item-wrapper">
		<div class="w_grid w_2col w_1col_view_small">
			...
			<div class="w_padding">
				<h1>{$element.Name}</h1>
				<div class="legal-item-date">{$element.NDate|date_format:"%d.%m.%Y"}</div>
				<div class="legal-item-text">{$element.Descr}</div>
	...
	<div class="w_interval"></div>
	<section>
		<section class="legal-wrapper w_animate w_grid w_3col w_2col_view_medium w_1col_view_small w_gap">
