<?php
namespace WeppsExtensions\Test;
...
class TestWepps extends ExtensionWepps {
	public function request() {
		$smarty = SmartyWepps::getSmarty ();
		switch (NavigatorWepps::$pathItem) {
			case '':
				$this->tpl = 'packages/WeppsExtensions/Test/Test.tpl';
				...
				break;
			default:
				$this->tpl = 'packages/WeppsExtensions/Test/TestItem.tpl';
		...
		$this->headers->css("/ext/Test/Test.{$this->rand}.css");
		$this->headers->js("/ext/Test/Test.{$this->rand}.js");
