...
<div class="settings pps_flex pps_flex_row pps_flex_center">
	<form
		action="javascript:formSenderPPS.send('setSettings','emailForm','/ext/User/Request.php')"
	...
	<form
		action="javascript:formSenderPPS.send('setSettings','phoneForm','/ext/User/Request.php')"
	...
	<form
		action="javascript:formSenderPPS.send('setSettings','passForm','/ext/User/Request.php')"
