<div class="pps_flex pps_flex_row pps_flex_center">
    <form action="javascript:formWepps.send('change-name','change-name-form','/ext/Profile/Request.php')" id="change-name-form"
...
<div class="pps_flex pps_flex_row pps_flex_center">
    <form action="javascript:formWepps.send('change-email','change-email-form','/ext/Profile/Request.php')" id="change-email-form"
        class="pps_form pps_flex_12 pps_flex_11_view_medium" autocomplete="off">
        <h2>E-mail</h2>
        <fieldset>
            <section>
...
<div class="pps_flex pps_flex_row pps_flex_center">
    <form action="javascript:formWepps.send('change-phone','change-phone-form','/ext/Profile/Request.php')" id="change-phone-form"
        class="pps_form pps_flex_12 pps_flex_11_view_medium" autocomplete="off">
        <h2>Телефон</h2>
        <fieldset>
            <section>
...
<div class="pps_flex pps_flex_row pps_flex_center">
    <form action="javascript:formWepps.send('change-password','change-password-form','/ext/Profile/Request.php')" id="change-password-form"
        class="pps_form pps_flex_12 pps_flex_11_view_medium" autocomplete="off">
        <h2>Пароль</h2>
        <fieldset>
            <section>
