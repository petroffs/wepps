<div class="elements Services">
	<div class="items pps_flex pps_flex_row pps_flex_row_str pps_flex_start pps_flex_margin">
		...
		<div class="item pps_flex_13">
			<div class="img">
				<img src="{if $images.0}/pic/catbig{$images.0}{else}/pic/catbig/files/lists/DataTbls/6_Image_1337064015_BS16032.jpg{/if}" class="pps_image"/>
			</div>
