	...
	<section class="w_flex_12">
		<a href="">
			<div class="services-img">
				<img src="{if $images.0}/pic/catbig{$images.0}{else}/ext/Template/files/noimage.png{/if}" class="w_image"/>
			</div>
			...
			<div class="services-text w_hide">
				...
				<div class="img"><img src="{if $images.0}/pic/catbig{$images.0}{else}/ext/Template/files/noimage.png{/if}" class="w_image"/></div>
