...
<div class="pps_flex_11 pps_flex pps_flex_row pps_flex_row_str">
	...
	<div class="pps_flex_11 pps_flex pps_flex_col pps_padding centercontent">
		<div class="pps_shadow pps_flex_max pps_padding">
			<h2>{$content.Name}</h2>
			<form class="list-data pps_flex pps_flex_row pps_flex_center" action="javascript:formSenderWepps.send('auth','auth-form','/packages/WeppsAdmin/Admin/Request.php')"
				id="auth-form">
