<form class="list-data w_flex w_flex_row w_flex_start w_flex_row_top controls-area"
	...
	<div class="w_rounded w_flex_23 w_flex_11_view_medium w_grid w_4col w_1col_view_small w_gap w_border">
		<label class="w_label w_input"><input name="list" type="text" value="" placeholder="Таблицы БД" /></label>
...
{if $backups}
	...
	<form class="list-data w_flex w_flex_row w_flex_start w_flex_row_top controls-area">
		<div class="w_rounded w_flex_23 w_flex_11_view_medium w_border">
			<div class="title">Последние бекапы</div>
			<div class="w_interval_small"></div>
			<ul class="w_list">
				{foreach name="out" item="item" from=$backups}
					<li class="w_pointer" data-file="{$item}" data-restore="database-restore" data-remove="database-remove">
						<i class="bi bi-file-earmark-code"></i> {$item}
					</li>
				{foreachelse}
