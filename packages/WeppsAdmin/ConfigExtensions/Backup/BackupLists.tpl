<form class="list-data w_flex w_flex_row w_flex_start w_flex_row_top controls-area"
	...
	<div class="w_rounded w_flex_23 w_flex_11_view_medium w_border">
		<div class="w_flex w_flex_row w_flex_start w_flex_margin">
			<label class="w_label w_select w_flex_12 listsBox"> <select id="lists">
			...
			<label class="w_label w_button"><input type="button" value="Структура" id="backupListStructure" /></label>
			<label class="w_label w_button"><input type="button" value="Данные" id="backupListData" /></label>
		</div>
	</div>
</form>